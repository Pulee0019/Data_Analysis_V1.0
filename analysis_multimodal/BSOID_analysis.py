...
from analysis_multimodal.Multimodal_analysis import (
    ...
    export_results, get_events_from_bsoid,
...
class TableManager:
    ...
    def run_analysis(self, params):
        ...
        run_bsoid_analysis(row_data, params)
        
def run_bsoid_analysis(row_data, params):
    ...
    for row_name, animals in row_data.items():
        ...
        row_result, row_stats = analyze_row_bsoid(row_name, animals, params)
...
def analyze_row_bsoid(row_name, animals, params):
    ...
    for animal_data in animals:
        try:
            ...
            result = calculate_event_traces(events, fiber_timestamps, dff_data, active_channels, target_wavelengths,
                                            params['plot_pre'], params['plot_post'], params['baseline_start'], params['baseline_end'])
...
def calculate_event_traces(events, fiber_timestamps, dff_data, active_channels, target_wavelengths, plot_pre, plot_post, baseline_start, baseline_end):
